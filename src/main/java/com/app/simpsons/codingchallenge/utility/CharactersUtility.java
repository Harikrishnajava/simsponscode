...
import com.app.simpsons.codingchallenge.repository.DataSim;
import com.app.simpsons.codingchallenge.repository.IDataBase;
...
public class CharactersUtility extends Utility implements IDataBase<Characters>
{
	...
	private DataSim _dbs;
	
	public CharactersUtility(DataSim DBS) 
	{
		_dbs = DBS;
	}
